<%-- 
    ...
    Created on : Mar 16, 2017, 10:28:17 AM
    Author     : kamallala
--%>
...
<html>
    ...
    <body>
         <form action="cancel_ticket.jsp">
            ...
            <input type="radio" name="class" value="Business"> BUSINESS</tr><br><br>
            Enter the number of tickets <input type="number" name="eno"><br>
             <input type="submit" name="state" value="cancelTicket"/>
